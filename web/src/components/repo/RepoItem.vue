<template>
  <router-link
    ...
    class="border-wp-border-100 dark:border-wp-border-100 bg-wp-background-300 dark:bg-wp-background-300 hover:border-wp-border-200 hover:bg-wp-control-neutral-200 dark:hover:bg-wp-control-neutral-100 flex cursor-pointer flex-col overflow-hidden rounded-lg border p-4 shadow-sm transition-all duration-150"
  >
